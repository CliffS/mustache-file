...
(function() {
  ...
  Mustache = (function() {
    ...
    Mustache.prototype.readFile = function(filename, callback) {
      ...
      findFirst = (function(_this) {
        return function(callback) {
          ...
          file = _this.extension != null ? Path.join(path, filename + "." + _this.extension) : Path.join(path, filename);
    ...
    Mustache.prototype._render = function(file, context, callback) {
      this.parts = {};
    ...
    Mustache.prototype.render = function(file, context, callback) {
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return _this._render(file, context, function(err, result) {
            if (err) {
              return reject(err);
            }
